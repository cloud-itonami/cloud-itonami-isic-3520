# Operator Quickstart — Community Gas Supply Distribution Operations

Shortest path from clone to a verified local dry-run for **ISIC 3520** (`cloud-itonami-isic-3520`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3520.git
cd cloud-itonami-isic-3520
```
...
- Blueprint governor key: `gas-safety-governor`
- Likely source path: `gas.governor.cljc`
